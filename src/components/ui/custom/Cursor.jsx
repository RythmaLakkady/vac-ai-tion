...
export default function Cursor() {
  ...
  return (
    <>
      <div
        className="fixed top-0 left-0 w-4 h-4 bg-amber rounded-full pointer-events-none z-[9999] mix-blend-multiply transition-transform duration-100 ease-out hidden md:block"
        style={{

...
function Footer() {
  ...
  return (
    <>
      <footer className="w-full py-8 mt-20 border-t border-holiday-coral/15 bg-holiday-cream/50 backdrop-blur-md">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-holiday-dark font-sans">
            <span className="font-serif font-semibold text-lg">vac-ai-tion</span>
            <span className="text-holiday-dark/30">|</span>
          ...
          <div className="flex items-center gap-4 flex-wrap justify-center">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-holiday-coral to-holiday-amber text-white rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105 font-semibold font-sans text-sm shadow-md"
            >
